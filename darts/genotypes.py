...
def to_dag(C_in, gene):
    ...
    for edges in gene:
        ...
        for op_name, s_idx in edges:
            ...
            stride = 1 if s_idx < 2 else 1
            op = ops.OPS[op_name](C_in, stride)
...
def parse(alpha, k):
    ...
    for edges in alpha:
        ...
        for edge_idx in topk_edge_indices:
            ...
            node_gene.append((prim, edge_idx.item()))  # node_gene [(node1_ops_1, edge_idx), (node1_ops_2, edge_idx)]
            normal_cnn_count += 1
        gene.append(node_gene)  # [[(node1_ops_1, edge_idx), (node1_ops_2, edge_idx)],
                                # [(node1_ops_1, edge_idx), (node1_ops_2, edge_idx)]]

    return gene, normal_cnn_count


#
FedNAS_V1 = Genotype(normal=[[('sep_conv_3x3', 1), ('sep_conv_5x5', 0)], [('sep_conv_3x3', 1), ('sep_conv_5x5', 2)],
                             [('sep_conv_5x5', 0), ('std_conv_7x7', 3)]], normal_concat=range(2, 5))
